...
var VContainer = (_temp = _class = function (_Component) {
    ...
    */
      ...
      */
			...
			// add spacers
			rows.unshift(_react2.default.createElement('div', { key: 'top_spacer', style: { height: top_spacer_height } }));
			rows.push(_react2.default.createElement('div', { key: 'bottom_spacer', style: { height: bottom_spacer_height } }));
